...
class NativeUI(HEVClient, QMainWindow):
    ...
    def __define_connections(self) -> int:
        ...
        for widget in (self.mode_handler.spinDict.values()):
            ...
            widget.simpleSpin.manualChanged.connect(lambda i=widget: self.clinical_handler.setpoint_changed(i))
            widget.simpleSpin.manualChanged.connect(lambda i=widget: self.mode_handler.propagate_modevalchange(i))
        ...
        self.messageCommandPopup.ClinicalSend.connect(self.clinical_handler.sendCommands)
